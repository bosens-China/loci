...
describe('parsePage', () => {
  it('extracts page metadata, readable markdown, and normalized links', () => {
    const page = parsePage(
      '<html lang="zh-CN"><head><title>开始使用</title></head><body><nav>菜单</nav><main><h1>开始使用</h1><p><strong>你好</strong>，文档。</p><a href="/next?from=home#top">下一页</a></main><script>ignored()</script></body></html>',
